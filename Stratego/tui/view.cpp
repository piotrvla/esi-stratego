...
string View::askSwap()
{
    ...
    cout << "To swap pieces, type the two piece positions like this :"
         << " A7 C7"
         << endl;
    cout << "Type END to start the game" << endl;
    getline(cin, swapParams);
    transform(swapParams.begin(),
              swapParams.end(),
              swapParams.begin(),
              ::toupper);
...
string View::askMove()
{
    ...
    cout << "Insert position from where you'd like to move, then direction, then the distance(optional)"
         << endl;
    cout << "Example: A7 TOP" << endl;
    getline(cin, moveParams);
    transform(moveParams.begin(), moveParams.end(), moveParams.begin(),
              ::toupper);
...
char View::askCheatMode()
{
    ...
    transform(cheatMode.begin(), cheatMode.end(), cheatMode.begin(),
              ::tolower);
...
{
    cout << "Current player is the player: " << facade.getCurrentPlayer() <<
         endl;
}
